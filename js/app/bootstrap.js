...
function render(){
 try{
   ...
   const pages={dashboard,decks,collection:collectionPage,optimizer:optimizerPage,matches,stats:statsPage,meta:metaPage,tournaments:window.tournamentsPage||dashboard,rank:rankBorderPage,trade:tradePage,streamer:window.streamerPage||streamerPage,coach:window.pocketCoachPage||dashboard,training:window.trainingPage||dashboard,profile:window.profilePage||accountPage,teamwars:window.teamWarsPage||dashboard,sync:window.pocketSyncPage||accountPage,account:accountPage,about:aboutPage,more:morePage};
