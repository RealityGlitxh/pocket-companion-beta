/* PocketNexus V8.67.2 — Ranked Stream Control Center
...
(function(){
  ...
  function ensureStyles(){
    ...
    link.rel='stylesheet';
    link.href='css/streamer-ranked-refine-v8.67.2.css?v=867201';
  ...
  function buildPrimaryGrid(app){
    ...
    [live,quick,rank,perf].forEach(p=>grid.appendChild(p));
  }
  ...
  window.PPCStreamerRankedRefine={version:'8.67.2',apply,install};
})();
