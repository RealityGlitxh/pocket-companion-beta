...
const VERSION='v8.64.2-ranked-stream-control-qa-hotfix';
...
const APP_SHELL=[
 ...
 './js/features/ui-dialogs.js','./js/features/whats-new-v8.33.js','./js/features/tournament-leaderboards-v8.31.js','./js/features/training-slide-hotfix-v8.64.1.js','./js/features/training-cleanup-hotfix-v8.64.1.js','./js/app/bootstrap.js','./js/core/navigation-v8.33.js',
 ...
 './js/services/pocket-sync-adapter-service.js','./js/services/pocket-sync-orchestrator-service.js','./js/app/pocket_sync.js','./js/features/experience-v8.36.js','./js/features/battle-streamer-v8.43.js','./js/app/account_startup.js','./js/features/expansion-v8.49.js','./js/features/stability-v8.50.js','./js/features/streamer-workspaces-recovery-v8.64.2.js','./js/app/pwa.js'
];
